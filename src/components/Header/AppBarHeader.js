        ...
        <AppBar position="static" sx={{ backgroundColor: "#FFFFFF" }}>
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    <Box component="button" onClick={onBtnMiushopClick} backgroundColor="black" sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }}>
                    ...
                    >
                         <Box noWrap backgroundColor="black" sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }}>
